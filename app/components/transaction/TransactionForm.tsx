  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="NL">
      ...
      <TextField
        ...
        helperText={
          !crud.title || crud.title?.length === 0 ? "Empty field!" : " "
        }
        defaultValue={crud.title}
        onChange={(e) => {
      ...
      <TextField
        ...
        helperText={
          !crud.description || crud.description?.length === 0
            ? "Empty field!"
            : " "
        }
        defaultValue={crud.description}
        onChange={(e) => {
      ...
      <p />
      <Button onClick={saveData} color={transaction ? "success" : "info"}>
